namespace Game.Unit.Skills.Effects {
    ...
    public class HealSkillEffect : SkillEffect {
        ...
        public override bool CanApply(UnitObject target) => target != null && !target.Unit.IsDead() && !target.Unit.IsStatFull(StatType.Hp);

        public override IEnumerator Apply(UnitObject user, GridPosition targetPosition, BattleMapManager battleMapManager) {
